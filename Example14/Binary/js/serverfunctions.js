...
function TSM(connectionInfo)
{
   ...
   * @return result - Type on server: string
   */
  this.SumString = function(A, B) {
    var returnObject = this.executor.executeMethod('SumString', "GET", [A, B], arguments[2], true, arguments[3], arguments[4]);
    if (arguments[2] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.SumString_URL = function(A, B) {
    return this.executor.getMethodURL("SumString", "GET", [A, B], arguments[2])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TSM": ["EchoString","ReverseString","Sum","SumString"]
};
