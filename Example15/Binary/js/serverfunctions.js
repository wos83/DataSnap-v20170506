...
function TSM(connectionInfo)
{
  ...
  this.GetEmployee = function() {
    var returnObject = this.executor.executeMethod('GetEmployee', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetEmployee_URL = function() {
    return this.executor.getMethodURL("GetEmployee", "GET", [], arguments[0])[0];
  };

  /*
   * @return result - Type on server: string
   */
  this.GetEmployeeJson = function() {
    var returnObject = this.executor.executeMethod('GetEmployeeJson', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetEmployeeJson_URL = function() {
    return this.executor.getMethodURL("GetEmployeeJson", "GET", [], arguments[0])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TSM": ["EchoString","ReverseString","GetEmployee","GetEmployeeJson"]
};
